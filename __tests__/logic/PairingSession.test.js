...
/**
 * Filename: PairingSession.test.js
 * Description: Tests serialization/deserialization of PairingSession objects
 * Author: Dipti Mahamuni
 */

import { PairingSession } from "../../logic/PairingSession";
...
describe("PairingSession", () => {
  it("serializes and deserializes", async () => {
    const oldObj = new PairingSession(KeyTypes.Ed25519, {});

    const oldStr = oldObj.toString();

    const serialized = oldObj.serialize();

    const newObj = new PairingSession(KeyTypes.Ed25519, {});
